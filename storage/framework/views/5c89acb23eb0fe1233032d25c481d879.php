<div>
    <div style="overscroll-behavior: none;">
        <div class="fixed w-full bg-green-400 h-16 pt-2 text-white flex items-center shadow-md" style="top: 0;">
            ...
            <div class="flex-grow text-center text-green-100 font-bold text-lg tracking-wide"><?php echo e($user->name); ?></div>
        </div>
                    ...
                    <?php if($message['sender'] != auth()->user()->name): ?>
                        <div class="bg-gray-300 mx-4 my-2 p-2 rounded-lg inline-block">
                            <?php if($message['reply_to']): ?>
                                <div class="text-gray-600 text-sm">Replying to: <?php echo e($message['reply_to']); ?></div>
                            <?php endif; ?>
                            <?php echo e($message['message']); ?>

                            <button wire:click="setReply(<?php echo e($message['id']); ?>)" class="text-blue-500 text-sm ml-2">Reply</button>
                        </div>
                    <?php else: ?>
    ...
    <form wire:submit.prevent="sendMessage">
        <div class="fixed w-full flex flex-col bg-green-100" style="bottom: 0;">
            <?php if($replyToMessageId && $replyMessagePreview): ?>
                <div class="bg-gray-200 p-2 rounded-lg mb-1">
                    <span>Replying to: </span><strong><?php echo e($replyMessagePreview); ?></strong>
...
</div><?php /**PATH C:\xampp\htdocs\AssistMate\resources\views\livewire\chat-component.blade.php ENDPATH**/ ?>