                ...
                <div class="p-6 text-gray-900">
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="flex items-center border-b border-gray-200 py-3">
                            ...
                            <div class="flex-grow">
                                <a href="<?php echo e(route('chat', $user->id)); ?>" class="text-gray-900 font-medium hover:text-green-600">
...
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\AssistMate\resources\views\dashboard.blade.php ENDPATH**/ ?>